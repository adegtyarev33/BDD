...
\item[\hyperlink{todo__todo000002}{Необходимо сделать}]Реализовать алгоритм поиска связей с логическими 0 и 1 и их удаления (прим.\+: эффективность не в приоритете! нужен сам алгоритм!) \end{DoxyRefDesc}
